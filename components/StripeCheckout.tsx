        ...
        <div className="bg-white dark:bg-black rounded-2xl shadow-xl overflow-hidden max-w-md w-full">
            ...
            <div className="bg-gradient-to-r from-amber-500 to-orange-500 p-6 text-white">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-2xl font-bold">
                        {t('manageSubscription') || 'Abonnement'}
                    </h2>
                    {onClose && (
                        <button
                            onClick={onClose}
            ...
            <div className="p-6">
                ...
                <ul className="space-y-3 mb-6">
                    {[
                        t('subscriptionFeature1') || 'Accès au contenu',
                        t('subscriptionFeature2') || 'Qualité standard',
                ...
                >
                    {loading ? (
                        ...
                        <>
                            ...
                            <span>{t('subscribeNow') || 'Souscrire maintenant'}</span>
                        </>
                    )}
                </button>
